    ...
    stages {
        ...
        stage('Load test') {
            steps {
               ...
               bat ' loadtestrunner.bat -s"http://localhost:8081 TestSuite" -c"Signup TestCase" -l"LoadTest 2" -r -f”C:/Users/Jose/Desktop” "C:/Users/Jose/Downloads/Programacion/Codigos/SOAPUi y Jmeter/REST-Project-1-soapui-project.xml"'
